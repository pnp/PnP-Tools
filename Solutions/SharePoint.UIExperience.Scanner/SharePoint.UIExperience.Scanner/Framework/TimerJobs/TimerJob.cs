...
using SharePoint.UIExperience.Scanner.Framework.TimerJobs.Enums;
using SharePoint.UIExperience.Scanner.Framework.TimerJobs.Utilities;
using System.Security.Cryptography.X509Certificates;
using SharePoint.UIExperience.Scanner.Utilities;

namespace SharePoint.UIExperience.Scanner.Framework.TimerJobs
{
    #region Delegates
    /// <summary>
