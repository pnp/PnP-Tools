...
using SharePoint.SandBoxTool.Framework.TimerJobs.Enums;
using SharePoint.SandBoxTool.Framework.TimerJobs.Utilities;
using System.Security.Cryptography.X509Certificates;
using SharePoint.SandBoxTool.Utilities;

namespace SharePoint.SandBoxTool.Framework.TimerJobs
{
    #region Delegates
    /// <summary>
