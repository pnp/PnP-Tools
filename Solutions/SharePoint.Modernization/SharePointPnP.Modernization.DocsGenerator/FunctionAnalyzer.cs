...
namespace SharePointPnP.Modernization.DocsGenerator
{
    public class FunctionAnalyzer
    {
        ...
        public FunctionAnalyzer(Assembly assemblyToAnalyze)
        {
        ...
        public List<Function> Analyze()
        {
            foreach (var type in assembly.GetTypes())
            {
                ...
                {
                    var attributes = method.GetCustomAttributes<SharePointPnP.Modernization.Framework.Functions.FunctionDocumentationAttribute>();
