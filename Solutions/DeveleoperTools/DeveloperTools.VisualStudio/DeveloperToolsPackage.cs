//------------------------------------------------------------------------------
// <copyright file="DeveloperToolsPackage.cs" company="Company">
...
using EnvDTE;
using SharePointPnP.DeveloperTools.VisualStudio.Extenders;
...
namespace SharePointPnP.DeveloperTools.VisualStudio
{
	...
	public sealed class DeveloperToolsPackage : Package
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="DeveloperToolsPackage"/> class.
		/// </summary>
