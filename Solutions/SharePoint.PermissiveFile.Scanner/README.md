...
---------| -----| --------
1.8 | October 9th 2018 | Build as x64 to get better memory management
1.7 | June 20th 2018 | Introduced light mode, skipping site owner/admin retrieval and html file processing
1.6 | March 7th 2018 | Reliability improvements
...
You can download the tool from here:
 - [Permissive file scanner for SharePoint Online](https://github.com/SharePoint/PnP-Tools/blob/master/Solutions/SharePoint.PermissiveFile.Scanner/Releases/SharePoint.PermissiveFile.Scanner%20v1.8.zip?raw=true)
