...
.description
This script is designed specifically to deploy a hybrid cloud Search Service Application to a SharePoint Server farm
All components are configured on the services selected
Change the script if you have more services or want certain components on certain servers
...
.example
.\CreateHybridCloudSSA.ps1 -SearchApplicationPoolAccountName "appoolname" -DatabaseServer "spsql" -SearchServer1 "spba01" -SearchServer2 "SPfe01"
#> 
