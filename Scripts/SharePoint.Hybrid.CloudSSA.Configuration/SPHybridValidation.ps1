<#
.synopsis
Script does several checks on the farm and Office 365 if a hybrid connection can be setup
.description
This script needs to be ran on a SharePoint server that has access to internet
.example
...
$licensed = Get-MsolUser | where-object {$_.IsLicensed -eq $true}
